...
сам джанго располагается в папке /home/i/ilya1985/patapum.org/public_html/venv/lib/python3.11/site-packages
 
для начала надо переключиться на текущий virtualenv
заходим в папку с проектом
 
$ cd /home/i/ilya1985/patapum.org/public_html
$ source venv/bin/activate
 
проверяем правильно ли определился путь до pip:
$ which pip
/home/i/ilya1985/patapum.org/public_html/venv/bin/pip
...
$ pwd
/home/i/ilya1985/patapum.org/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt
